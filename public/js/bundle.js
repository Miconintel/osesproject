...
},{}],"XK0E":[function(require,module,exports) {
...
},{"./../utils":"zIVT","./../core/settle":"wZW9","./../helpers/cookies":"OhlP","./../helpers/buildURL":"RS1v","../core/buildFullPath":"d0lp","./../helpers/parseHeaders":"T8HP","./../helpers/isURLSameOrigin":"DmB6","../core/createError":"lGrg","../defaults/transitional":"XK0E","../cancel/Cancel":"RlDD"}],"rH1J":[function(require,module,exports) {
...
var searchFood = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/foods/?category=".concat(product));

          case 3:
            res = _context.sent;
            model = res.data.data; // console.log (model)
  ...
  return function searchFood(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.searchFood = searchFood;
},{"axios":"../../node_modules/axios/index.js"}],"carts.js":[function(require,module,exports) {
"use strict";
...
var getCartItem = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/foods/".concat(id));
  ...
  return function getCartItem(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.getCartItem = getCartItem;
},{"axios":"../../node_modules/axios/index.js"}],"loadFullCart.js":[function(require,module,exports) {
"use strict";
...
var hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); //   this is a trick to remove an element in javascript. u nedd it very well
...
var showAlert = function showAlert(type, message) {
  var time = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 10;
  hideAlert();
  var markUp = "<div class=\"alert alert--".concat(type, "\">").concat(message, "</div>");
  document.querySelector('body').insertAdjacentHTML('afterbegin', markUp);
  window.setTimeout(hideAlert, time * 1000); // to set a time out on a dom element u need to use the dom object.set timeout
};

exports.showAlert = showAlert;
},{}],"logins.js":[function(require,module,exports) {
"use strict";
...
var signUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(firstname, lastname, email, password, passwordConfirmed) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (response.data.status === 'success') (0, _alert.showAlert)('success', 'logged out succesfuly');
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', 'something happened');
...
var stripe = Stripe("pk_test_51Kqu9NHVqQpkAuMelrOd8IPdiiFI80yCyJj0GQ6Z9XUng3SlyhrGbljFjKUwfyTRx5s8wXxeMqANZXMV3CChjzw500svbt4gYc"); // export const buyFoods = async (foodId) => {
//   try {
//     // get checkout ession
...
var buyFood = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(foodId) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(foodId));

          case 3:
            session = _context.sent;
            console.log(session);
            console.log(stripe); // use stripe to
          ...
          case 10:
            ...
            _context.t0 = _context["catch"](0);
            console.log(_context.t0);
            (0, _alert.showAlert)('error', 'sorry try again there was an error');
            throw _context.t0;
  ...
  return function buyFood(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.buyFood = buyFood;
...
var _loadFullCart = _interopRequireDefault(require("./loadFullCart"));
...
var loadNewbookmarked = function loadNewbookmarked(par, itemNo, itemName) {
  var html = "<div class=\"add-to-cart-container\"><p class=\"added--to--cart\">Added ".concat(itemNo ? itemNo : '', " ").concat(itemName ? itemName : '', " to cart</p>\n  <button class=\"button button--remove--cart\">\nremove\n</button></div>\n  ");
...
var assignCartNumber = function assignCartNumber(state) {
  cartNumber.textContent = state.cartCount;
}; // HANDLER FUNCTION


var addToCartPro = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(clickedProduct, noOfItems) {
    var bookmarkPro, data, allData;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _carts.getCartItem)(clickedProduct.id);

          case 2:
            bookmarkPro = _context.sent;
  ...
  return function addToCartPro(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
parentCartContainer && parentCartContainer.addEventListener('click', addtoCart); // REMOVE FROM CART

var removeCartPro = function removeCartPro(parentEl) {
...
var removeCart = function removeCart(e) {
  ...
  if (clicked) {
    ...
    removeCartPro(productParent); // return the cart btton
...
parentCartContainer && parentCartContainer.addEventListener('click', removeCart); // GET LOCAL STATE
...
reloadButtons(allState); /// SET HERO HEIGHT
//
//
//
...
var otherPageCallback = function otherPageCallback(entries, observer) {
  ...
  if (!entry.isIntersecting) {
    ...
    header.classList.add('fixed'); // observer.observe(header);
  }
};

var otherPageOptions = {
  root: null,
  threshold: 0,
  rootMargin: "".concat(headerHeight * 20, "px")
};
var observerOtherPage = new IntersectionObserver(otherPageCallback, otherPageOptions);
...
parentCartContainer && parentCartContainer.addEventListener('click', function (e) {
  ...
  if (clicked) {
    var clickedParent = clicked.parentElement; // console.log(clickedParent)
...
var addToCartProduct = function addToCartProduct(e) {
  var clicked = e.target.closest('.button--cart');
  if (!clicked) return;
...
fullDescription && fullDescription.addEventListener('click', addToCartProduct); // AUTOMATED RELOAD FOR PRODUCT PAGE

var reloadButton = function reloadButton(state) {
  if (!window.location.pathname.includes('product')) return;
  var product = document.querySelector('.product-name');
  var parent = product.parentElement;
  var cartButton = parent.children[parent.children.length - 1];
...
var removeCartProduct = function removeCartProduct(e) {
  // console.log(e.target);
  var clicked = e.target.classList.contains('button--remove--cart');
  ...
  if (clicked) {
    ...
    assignCartNumber(allState);
    window.localStorage.setItem('state', JSON.stringify(allState));
    var cartB = productParent.children[productParent.children.length - 2];
    cartB.classList.remove('hide--again');
    var childPull = productParent.children[productParent.children.length - 1];
    productParent.removeChild(childPull); // persist crt
  }
};

fullDescription && fullDescription.addEventListener('click', removeCartProduct);

var increaseCartProductDetails = function increaseCartProductDetails(e) {
  var clicked = e.target.closest('.button-plus-minus');
...
productInnerContainer && productInnerContainer.addEventListener('click', increaseCartProductDetails); // DISPLAY CART
...
var calculateSum = function calculateSum(c) {
  var y = _toConsumableArray(document.querySelectorAll("".concat(c)));

  var total = y.map(function (el) {
    return el.textContent;
  });
  var grandTotal = total.reduce(function (acc, el) {
    return acc + Number(el);
  }, 0);
  var final = grandTotal.toFixed(0);
  var summaryTotals = _toConsumableArray(document.querySelectorAll("[data-total]")).map(function (el) {
    return el.textContent;
...
headerH.addEventListener('click', showCarts); // closing the display message
...
var addQtyPrice = function addQtyPrice(e) {
  var clicked = e.target.closest('.cart--list__element');
  if (!clicked || clicked.classList.contains('cart--list__header')) return;
  var checkButton = e.target.closest('.button-plus-minus');
  var qtyIcons = clicked.children[3];
  var priceElement = clicked.children[2].children[0].firstElementChild;
  var priceSpan = Number(priceElement.textContent);
  ...
  if (checkButton !== null && checkButton !== void 0 && checkButton.classList.contains('button--plus')) {
    ...
    var totals = calculateSum('.sub--totals');
    document.querySelector('.grand--total').textContent = totals[0];
    document.querySelector('.final--total').textContent = totals[1]; // console.log(priceSpan,currentValue,subPrice)
  }

  if (checkButton !== null && checkButton !== void 0 && checkButton.classList.contains('button--minus') && qtyIcons.children[1].value - 1 !== 0) {
    ...
    var _totals = calculateSum('.sub--totals');

    document.querySelector('.grand--total').textContent = _totals[0];
    document.querySelector('.final--total').textContent = _totals[1];
  }
};

document.addEventListener('click', addQtyPrice);
document.addEventListener('change', function (e) {
  var clicked = e.target.closest('.product--unit--quantity');
  if (!clicked) return;
  var value = Number(clicked.value);
  var parentEl = clicked.closest('.cart--list__element'); // console.log(parentEl,value)

  var price = Number(parentEl.children[2].children[0].firstElementChild.textContent);
  var subTotalElement = parentEl.children[4].children[0].firstElementChild;
...
document.addEventListener('click', removeFromCartPAge); // SIGN UP FORM'

var form = document.querySelector('.form');

var signU = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var formElements, h, formObj;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            formElements = _toConsumableArray(document.querySelectorAll('.form--input'));

            if (!formElements.some(function (el) {
              return el.value == '';
            })) {
              _context2.next = 4;
              break;
            ...
            return _context2.abrupt("return", console.log('pls fil in the space'));

          case 4:
            h = formElements.map(function (el) {
              return [el.getAttribute('name'), el.value];
            });
            formObj = h && Object.fromEntries(h);
            ...
            _context2.next = 10;
            return (0, _logins.signUp)(formObj.firstname, formObj.lastname, formObj.email, formObj.password, formObj.passwordConfirmed);
          ...
          case 10:
            ...
            _context2.next = 15;
            return (0, _logins.login)(formObj.email, formObj.password);
...
var logouts = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            clicked = e.target.closest('.list--cta');
  ...
  return function logouts(_x4) {
    return _ref3.apply(this, arguments);
  };
}();

allButtons && allButtons.addEventListener('click', logouts); // CHECKOUT

var checkoutButton = document.querySelector('.checkout--button');

var buyFoodHandler = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = checkoutButton.dataset.id; // console.log(id)

            _context4.next = 5;
            return (0, _stripe.buyFood)(id);
...
},{"../utils":"zIVT","../helpers/normalizeHeaderName":"TOXd","../core/enhanceError":"obgR","./transitional":"XK0E","../adapters/xhr":"LYEs","../adapters/http":"LYEs","process":"rH1J"}],"i7gz":[function(require,module,exports) {
...
},{"./../utils":"zIVT","./transformData":"i7gz","../cancel/isCancel":"C9l1","../defaults":"M0sG","../cancel/Cancel":"RlDD"}],"Qj6T":[function(require,module,exports) {
...
},{"./utils":"zIVT","./helpers/bind":"nb4k","./core/Axios":"RB6n","./core/mergeConfig":"Qj6T","./defaults":"M0sG","./cancel/Cancel":"RlDD","./cancel/CancelToken":"VWBb","./cancel/isCancel":"C9l1","./env/data":"omJA","./helpers/spread":"Kbjq","./helpers/isAxiosError":"NLsH"}],"uj17":[function(require,module,exports) {
module.exports=require("./lib/axios");
},{"./lib/axios":"HXpE"}],"zfSF":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.searchFood=void 0;var e=r(require("axios"));function r(e){return e&&e.__esModule?e:{default:e}}function t(e,r,t,n,o,a,u){try{var c=e[a](u),i=c.value}catch(s){return void t(s)}c.done?r(i):Promise.resolve(i).then(n,o)}function n(e){return function(){var r=this,n=arguments;return new Promise(function(o,a){var u=e.apply(r,n);function c(e){t(u,o,a,c,i,"next",e)}function i(e){t(u,o,a,c,i,"throw",e)}c(void 0)})}}var o=function(){var r=n(regeneratorRuntime.mark(function r(t){var n;return regeneratorRuntime.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:return r.prev=0,r.next=3,(0,e.default)("/api/v1/foods/?category=".concat(t));case 3:n=r.sent,n.data.data,r.next=10;break;case 7:r.prev=7,r.t0=r.catch(0),console.log(r.t0);case 10:case"end":return r.stop()}},r,null,[[0,7]])}));return function(e){return r.apply(this,arguments)}}();exports.searchFood=o;
},{"axios":"uj17"}],"fDTP":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.getCartItem=void 0;var e=t(require("axios"));function t(e){return e&&e.__esModule?e:{default:e}}function r(e,t,r,n,o,a,u){try{var c=e[a](u),i=c.value}catch(s){return void r(s)}c.done?t(i):Promise.resolve(i).then(n,o)}function n(e){return function(){var t=this,n=arguments;return new Promise(function(o,a){var u=e.apply(t,n);function c(e){r(u,o,a,c,i,"next",e)}function i(e){r(u,o,a,c,i,"throw",e)}c(void 0)})}}var o=function(){var t=n(regeneratorRuntime.mark(function t(r){var n,o;return regeneratorRuntime.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:return t.prev=0,t.next=3,(0,e.default)("/api/v1/foods/".concat(r));case 3:return n=t.sent,o=n.data.data,t.abrupt("return",o);case 8:throw t.prev=8,t.t0=t.catch(0),console.log(t.t0),t.t0;case 12:case"end":return t.stop()}},t,null,[[0,8]])}));return function(e){return t.apply(this,arguments)}}();exports.getCartItem=o;
},{"axios":"uj17"}],"Eq09":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var a=function(a,n){var s=a.bookmarkPro.map(function(a){return'<figure class="cart--list__element flex">\n      <div class="cart--list__image"><img src="/img/product-images/'.concat(a[0].image,'" alt="').concat(a[0].slug,'" class="image image--cart__list" /></div>\n      <a class="link link--product--name" href="/productname/').concat(a[0].slug,'?page=1"><figcaption class="cart--options"><p class="paragraph product-name">').concat(a[0].productName,'</p></figcaption></a>\n      <figcaption class="cart--options"><p class="paragraph price">$<span class="price--effect">').concat(a[0].price,'</span></p></figcaption>\n      <div class="input--container">\n        <button\n          class="button button--icon button-plus-minus button--minus"\n        >\n          <svg class="feather">\n            ').concat(feather.icons.minus.toSvg({class:"icon icon--minus icon-plus-minus"}),'\n          </svg>\n        </button>\n        <input\n          type="text"\n          class="input product--unit--quantity"\n          name="product-unit"\n          value="').concat(a[1],'"\n        />\n        <button\n          class="button button--icon button-plus-minus button--plus"\n        >\n          <svg class="feather">\n            ').concat(feather.icons.plus.toSvg({class:"icon icon--minus icon-plus-minus"}),'\n          </svg>\n        </button>\n      </div>\n      <figcaption class="cart--options"><p class="paragraph price">$<span class="price--effect sub--totals" data-src="totals">').concat(a[1]*a[0].price,'</span></p></figcaption>\n      <button class="button button--close  mobile--nav--button">\n        <svg class="feather">\n          ').concat(feather.icons.x.toSvg({class:"icon icon--minus icon-plus-minus"}),"\n        </svg>\n      </button>\n    </figure>")}).join(""),t='<section class="cart--section">\n      <div class="content">\n          <div class="grid grid--2--columns--cart cart--list--container container">\n            '.concat('  \n    <div class="category--header">\n        <h2 class="secondary--header">Our Products</h2>\n\n        <div class="category--list-container">\n        <h3 class="tertiary--header">\n            <a href="/?product=all-products&page=1" class="link link--category active"\n            >Products</a\n            >\n        </h3>\n        <h3 class="tertiary--header">\n            <a href="/?category=Provisions&page=1" class="link link--category">Provisions</a>\n        </h3>\n        <h3 class="tertiary--header">\n            <a href="/?category=Grains&page=1" class="link link--category">Grains</a>\n        </h3>\n        <h3 class="tertiary--header">\n            <a href="/?category=Flour&page=1" class="link link--category">Flours</a>\n        </h3>\n        <h3 class="tertiary--header">\n            <a href="/?category=Spices&page=1" class="link link--category">Spices</a>\n        </h3>\n        <h3 class="tertiary--header">\n            <a href="/?category=Animal Protein&page=1" class="link link--category">Meat</a>\n        </h3>\n        <h3 class="tertiary--header">\n            <a href="/?category=Oil&page=1" class="link link--category">Oil</a>\n        </h3>\n        <h3 class="tertiary--header">\n            <a href="/?category=Others&page=1" class="link link--category">Others</a>\n        </h3>\n        </div>\n    </div>','\n            <div class="cart--lists">\n              <div class="cart--list__header cart--list__element flex">\n                  <h3 class="tertiary--header">Product Name</h3>\n                  <h3 class="tertiary--header">Product price</h3>\n                  <h3 class="tertiary--header">quantity</h3>\n                  <h3 class="tertiary--header">subtotal</h3>\n              </div>\n              ').concat(s,'\n            </div>\n    \n            <div class="checkout--side">\n    \n               <div class="checkout--side__element">\n    \n                <h3 class="tertiary--header summary--header">Summary</h3>\n    \n                <div class="summary--container grid grid--2--columns">\n                  <p class="paragraph">order total</p>\n                  <p class="paragraph price">$<span class="price--effect grand--total">6</span></p>\n                  <p class="paragraph ">Discount</p>\n                  <p class="paragraph price">$<span class="price--effect" data-total="totals">0</span></p>\n                  <p class="paragraph ">shipping</p>\n                  <p class="paragraph price">$<span class="price--effect" data-total="totals">0</span></p>\n                </div>\n    \n                <div class="total">\n                 <h3 class="tertiary--header paragraph">Total:</h3>\n                 <p class="paragraph price">$<span class="price--effect final--total">6</span></p>\n                </div> \n    \n               </div>\n               <button class="button checkout--button paragraph" >\n                  <strong>CHECKOUT</strong>\n              </button>\n            </div>\n              \n          </div>\n      </div>\n    </section>');n.insertAdjacentHTML("afterbegin",t)},n=a;exports.default=n;
},{}],"acK6":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.showAlert=exports.hideAlert=void 0;var e=function(){var e=document.querySelector(".alert");e&&e.parentElement.removeChild(e)};exports.hideAlert=e;var t=function(t,r){var o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:10;e();var n='<div class="alert alert--'.concat(t,'">').concat(r,"</div>");document.querySelector("body").insertAdjacentHTML("afterbegin",n),window.setTimeout(e,1e3*o)};exports.showAlert=t;
},{}],"C0nW":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.signUp=exports.logout=exports.login=void 0;var e=r(require("axios")),t=require("./alert");function r(e){return e&&e.__esModule?e:{default:e}}function n(e,t,r,n,s,o,a){try{var u=e[o](a),c=u.value}catch(i){return void r(i)}u.done?t(c):Promise.resolve(c).then(n,s)}function s(e){return function(){var t=this,r=arguments;return new Promise(function(s,o){var a=e.apply(t,r);function u(e){n(a,s,o,u,c,"next",e)}function c(e){n(a,s,o,u,c,"throw",e)}u(void 0)})}}var o=function(){var r=s(regeneratorRuntime.mark(function r(n,s,o,a,u){return regeneratorRuntime.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:return r.prev=0,console.log("see me"),r.next=4,(0,e.default)({method:"POST",url:"/api/v1/users/signup",data:{firstname:n,lastname:s,email:o,password:a,passwordConfirmed:u}});case 4:"success"===r.sent.data.status&&((0,t.showAlert)("success","logged in succesfuly"),window.setTimeout(function(){location.assign("/")},500)),r.next=11;break;case 8:r.prev=8,r.t0=r.catch(0),(0,t.showAlert)("error",r.t0.response.data.message);case 11:case"end":return r.stop()}},r,null,[[0,8]])}));return function(e,t,n,s,o){return r.apply(this,arguments)}}();exports.signUp=o;var a=function(){var r=s(regeneratorRuntime.mark(function r(n,s){return regeneratorRuntime.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:return r.prev=0,console.log("see me"),r.next=4,(0,e.default)({method:"POST",url:"/api/v1/users/login",data:{email:n,password:s}});case 4:"success"===r.sent.data.status&&((0,t.showAlert)("success","logged in succesfuly"),window.setTimeout(function(){location.assign("/")},500)),r.next=11;break;case 8:r.prev=8,r.t0=r.catch(0),(0,t.showAlert)("error",r.t0.response.data.message);case 11:case"end":return r.stop()}},r,null,[[0,8]])}));return function(e,t){return r.apply(this,arguments)}}();exports.login=a;var u=function(){var r=s(regeneratorRuntime.mark(function r(){return regeneratorRuntime.wrap(function(r){for(;;)switch(r.prev=r.next){case 0:return r.prev=0,r.next=3,(0,e.default)({method:"GET",url:"/api/v1/users/logout"});case 3:"success"===r.sent.data.status&&(0,t.showAlert)("success","logged out succesfuly"),location.reload(!0),r.next=12;break;case 8:r.prev=8,r.t0=r.catch(0),console.log(r.t0.response.data.message),(0,t.showAlert)("error","something happened");case 12:case"end":return r.stop()}},r,null,[[0,8]])}));return function(){return r.apply(this,arguments)}}();exports.logout=u;
},{"axios":"uj17","./alert":"acK6"}],"Uj2q":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.buyFood=void 0;var e=t(require("axios")),r=require("./alert");function t(e){return e&&e.__esModule?e:{default:e}}function n(e,r,t,n,o,s,u){try{var i=e[s](u),a=i.value}catch(c){return void t(c)}i.done?r(a):Promise.resolve(a).then(n,o)}function o(e){return function(){var r=this,t=arguments;return new Promise(function(o,s){var u=e.apply(r,t);function i(e){n(u,o,s,i,a,"next",e)}function a(e){n(u,o,s,i,a,"throw",e)}i(void 0)})}}var s=Stripe("pk_test_51Kqu9NHVqQpkAuMelrOd8IPdiiFI80yCyJj0GQ6Z9XUng3SlyhrGbljFjKUwfyTRx5s8wXxeMqANZXMV3CChjzw500svbt4gYc"),u=function(){var t=o(regeneratorRuntime.mark(function t(n){var o;return regeneratorRuntime.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:return t.prev=0,t.next=3,(0,e.default)("/api/v1/bookings/checkout-session/".concat(n));case 3:return o=t.sent,console.log(o),t.next=7,s.redirectToCheckout({sessionId:o.data.session.id});case 7:t.next=14;break;case 9:throw t.prev=9,t.t0=t.catch(0),console.log(t.t0),(0,r.showAlert)("error","sorry try again there was an error"),t.t0;case 14:case"end":return t.stop()}},t,null,[[0,9]])}));return function(e){return t.apply(this,arguments)}}();exports.buyFood=u;
},{"axios":"uj17","./alert":"acK6"}],"Focm":[function(require,module,exports) {
"use strict";require("core-js/modules/es6.array.copy-within.js"),require("core-js/modules/es6.array.fill.js"),require("core-js/modules/es6.array.filter.js"),require("core-js/modules/es6.array.find.js"),require("core-js/modules/es6.array.find-index.js"),require("core-js/modules/es7.array.flat-map.js"),require("core-js/modules/es6.array.from.js"),require("core-js/modules/es7.array.includes.js"),require("core-js/modules/es6.array.iterator.js"),require("core-js/modules/es6.array.map.js"),require("core-js/modules/es6.array.of.js"),require("core-js/modules/es6.array.slice.js"),require("core-js/modules/es6.array.sort.js"),require("core-js/modules/es6.array.species.js"),require("core-js/modules/es6.date.to-primitive.js"),require("core-js/modules/es6.function.has-instance.js"),require("core-js/modules/es6.function.name.js"),require("core-js/modules/es6.map.js"),require("core-js/modules/es6.math.acosh.js"),require("core-js/modules/es6.math.asinh.js"),require("core-js/modules/es6.math.atanh.js"),require("core-js/modules/es6.math.cbrt.js"),require("core-js/modules/es6.math.clz32.js"),require("core-js/modules/es6.math.cosh.js"),require("core-js/modules/es6.math.expm1.js"),require("core-js/modules/es6.math.fround.js"),require("core-js/modules/es6.math.hypot.js"),require("core-js/modules/es6.math.imul.js"),require("core-js/modules/es6.math.log1p.js"),require("core-js/modules/es6.math.log10.js"),require("core-js/modules/es6.math.log2.js"),require("core-js/modules/es6.math.sign.js"),require("core-js/modules/es6.math.sinh.js"),require("core-js/modules/es6.math.tanh.js"),require("core-js/modules/es6.math.trunc.js"),require("core-js/modules/es6.number.constructor.js"),require("core-js/modules/es6.number.epsilon.js"),require("core-js/modules/es6.number.is-finite.js"),require("core-js/modules/es6.number.is-integer.js"),require("core-js/modules/es6.number.is-nan.js"),require("core-js/modules/es6.number.is-safe-integer.js"),require("core-js/modules/es6.number.max-safe-integer.js"),require("core-js/modules/es6.number.min-safe-integer.js"),require("core-js/modules/es6.number.parse-float.js"),require("core-js/modules/es6.number.parse-int.js"),require("core-js/modules/es6.object.assign.js"),require("core-js/modules/es7.object.define-getter.js"),require("core-js/modules/es7.object.define-setter.js"),require("core-js/modules/es7.object.entries.js"),require("core-js/modules/es6.object.freeze.js"),require("core-js/modules/es6.object.get-own-property-descriptor.js"),require("core-js/modules/es7.object.get-own-property-descriptors.js"),require("core-js/modules/es6.object.get-own-property-names.js"),require("core-js/modules/es6.object.get-prototype-of.js"),require("core-js/modules/es7.object.lookup-getter.js"),require("core-js/modules/es7.object.lookup-setter.js"),require("core-js/modules/es6.object.prevent-extensions.js"),require("core-js/modules/es6.object.to-string.js"),require("core-js/modules/es6.object.is.js"),require("core-js/modules/es6.object.is-frozen.js"),require("core-js/modules/es6.object.is-sealed.js"),require("core-js/modules/es6.object.is-extensible.js"),require("core-js/modules/es6.object.keys.js"),require("core-js/modules/es6.object.seal.js"),require("core-js/modules/es6.object.set-prototype-of.js"),require("core-js/modules/es7.object.values.js"),require("core-js/modules/es6.promise.js"),require("core-js/modules/es7.promise.finally.js"),require("core-js/modules/es6.reflect.apply.js"),require("core-js/modules/es6.reflect.construct.js"),require("core-js/modules/es6.reflect.define-property.js"),require("core-js/modules/es6.reflect.delete-property.js"),require("core-js/modules/es6.reflect.get.js"),require("core-js/modules/es6.reflect.get-own-property-descriptor.js"),require("core-js/modules/es6.reflect.get-prototype-of.js"),require("core-js/modules/es6.reflect.has.js"),require("core-js/modules/es6.reflect.is-extensible.js"),require("core-js/modules/es6.reflect.own-keys.js"),require("core-js/modules/es6.reflect.prevent-extensions.js"),require("core-js/modules/es6.reflect.set.js"),require("core-js/modules/es6.reflect.set-prototype-of.js"),require("core-js/modules/es6.regexp.constructor.js"),require("core-js/modules/es6.regexp.flags.js"),require("core-js/modules/es6.regexp.match.js"),require("core-js/modules/es6.regexp.replace.js"),require("core-js/modules/es6.regexp.split.js"),require("core-js/modules/es6.regexp.search.js"),require("core-js/modules/es6.regexp.to-string.js"),require("core-js/modules/es6.set.js"),require("core-js/modules/es6.symbol.js"),require("core-js/modules/es7.symbol.async-iterator.js"),require("core-js/modules/es6.string.anchor.js"),require("core-js/modules/es6.string.big.js"),require("core-js/modules/es6.string.blink.js"),require("core-js/modules/es6.string.bold.js"),require("core-js/modules/es6.string.code-point-at.js"),require("core-js/modules/es6.string.ends-with.js"),require("core-js/modules/es6.string.fixed.js"),require("core-js/modules/es6.string.fontcolor.js"),require("core-js/modules/es6.string.fontsize.js"),require("core-js/modules/es6.string.from-code-point.js"),require("core-js/modules/es6.string.includes.js"),require("core-js/modules/es6.string.italics.js"),require("core-js/modules/es6.string.iterator.js"),require("core-js/modules/es6.string.link.js"),require("core-js/modules/es7.string.pad-start.js"),require("core-js/modules/es7.string.pad-end.js"),require("core-js/modules/es6.string.raw.js"),require("core-js/modules/es6.string.repeat.js"),require("core-js/modules/es6.string.small.js"),require("core-js/modules/es6.string.starts-with.js"),require("core-js/modules/es6.string.strike.js"),require("core-js/modules/es6.string.sub.js"),require("core-js/modules/es6.string.sup.js"),require("core-js/modules/es7.string.trim-left.js"),require("core-js/modules/es7.string.trim-right.js"),require("core-js/modules/es6.typed.array-buffer.js"),require("core-js/modules/es6.typed.int8-array.js"),require("core-js/modules/es6.typed.uint8-array.js"),require("core-js/modules/es6.typed.uint8-clamped-array.js"),require("core-js/modules/es6.typed.int16-array.js"),require("core-js/modules/es6.typed.uint16-array.js"),require("core-js/modules/es6.typed.int32-array.js"),require("core-js/modules/es6.typed.uint32-array.js"),require("core-js/modules/es6.typed.float32-array.js"),require("core-js/modules/es6.typed.float64-array.js"),require("core-js/modules/es6.weak-map.js"),require("core-js/modules/es6.weak-set.js"),require("core-js/modules/web.timers.js"),require("core-js/modules/web.immediate.js"),require("core-js/modules/web.dom.iterable.js");var e=require("regenerator-runtime");require("regenerator-runtime/runtime.js");var t=require("./search"),r=require("./carts"),o=c(require("./loadFullCart")),s=require("./logins"),n=require("./stripe"),i=require("./alert");function c(e){return e&&e.__esModule?e:{default:e}}function a(e,t){return d(e)||l(e,t)||v(e,t)||u()}function u(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function l(e,t){var r=null==e?null:"undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"];if(null!=r){var o,s,n=[],i=!0,c=!1;try{for(r=r.call(e);!(i=(o=r.next()).done)&&(n.push(o.value),!t||n.length!==t);i=!0);}catch(a){c=!0,s=a}finally{try{i||null==r.return||r.return()}finally{if(c)throw s}}return n}}function d(e){if(Array.isArray(e))return e}function m(e,t,r,o,s,n,i){try{var c=e[n](i),a=c.value}catch(u){return void r(u)}c.done?t(a):Promise.resolve(a).then(o,s)}function f(e){return function(){var t=this,r=arguments;return new Promise(function(o,s){var n=e.apply(t,r);function i(e){m(n,o,s,i,c,"next",e)}function c(e){m(n,o,s,i,c,"throw",e)}i(void 0)})}}function j(e){return h(e)||p(e)||v(e)||g()}function g(){throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}function v(e,t){if(e){if("string"==typeof e)return q(e,t);var r=Object.prototype.toString.call(e).slice(8,-1);return"Object"===r&&e.constructor&&(r=e.constructor.name),"Map"===r||"Set"===r?Array.from(e):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?q(e,t):void 0}}function p(e){if("undefined"!=typeof Symbol&&null!=e[Symbol.iterator]||null!=e["@@iterator"])return Array.from(e)}function h(e){if(Array.isArray(e))return q(e)}function q(e,t){(null==t||t>e.length)&&(t=e.length);for(var r=0,o=new Array(t);r<t;r++)o[r]=e[r];return o}feather.replace();var y=document.querySelector(".dots--container"),b=document.querySelectorAll(".slide"),k=document.querySelector(".button--chevron__left"),S=document.querySelector(".button--chevron__right"),C=document.querySelector(".main--header"),w=document.querySelector(".slider"),x=document.querySelector(".product--container"),L=document.querySelector(".nav"),E=document.querySelector(".footer--logo"),I=document.querySelector("body"),N=document.querySelector(".hero--section"),A=document.querySelector(".mobile--nav--button--container"),O=document.querySelector(".cart--number"),_=document.querySelector(".page--link"),P=document.querySelector(".category--header"),R=document.querySelector(".search--input"),J=document.querySelector(".button--search");(0,t.searchFood)("Provisions");var T,F=document.querySelectorAll(".link--category"),M=(F=j(F)).map(function(e){return e.textContent}),U=M.some(function(e){return"Provisions"===e}),z="g".slice(0,1).toUpperCase().concat("grai".slice(1)).startsWith("Grains".slice(0,2)),B=M.filter(function(e){return"gr".slice(0,1).toUpperCase().concat("gr".slice(1)).startsWith(e.slice(0,2))}),H=function(e){var t=R.value,r=M.filter(function(e){return t.slice(0,1).toUpperCase().concat(t.slice(1)).startsWith(e.slice(0,2))});if(t=r.join("")||t.slice(0,1).toUpperCase().concat(t.slice(1)),T=M.some(function(e){return e===t})?"category":"productName",window.localStorage.setItem("qhead",T),!t)return console.log("please input something");J.setAttribute("href","/?".concat(T,"=").concat(t,"&page=1")),window.localStorage.setItem("isClicked",JSON.stringify(t))};J.addEventListener("click",H),A&&A.addEventListener("click",function(e){var t=e.target.closest(".mobile--nav--button");t&&(t.classList.contains("mobile--menu")?C.classList.add("open"):t.classList.contains("mobile--close")&&C.classList.remove("open"))});var W=function(e){var t,r=e.target.closest(".button-plus-minus");r&&(r.firstElementChild.classList.contains("feather-plus")?(t=1*r.previousElementSibling.value,t++,r.previousElementSibling.value=t):r.firstElementChild.classList.contains("feather-minus")&&(1!==(t=1*r.nextElementSibling.value)&&t--,r.nextElementSibling.value=t))};x&&addEventListener("click",W);var X=function(e,t,r){var o='<div class="add-to-cart-container"><p class="added--to--cart">Added '.concat(t||""," ").concat(r||"",' to cart</p>\n  <button class="button button--remove--cart">\nremove\n</button></div>\n  ');e.insertAdjacentHTML("beforeend",o)},D={proCount:0,cartCount:0,bookmarkItems:[],bookmarkPro:[]},G=function(e){O.textContent=e.cartCount},V=function(){var e=f(regeneratorRuntime.mark(function e(t,o){var s,n,i;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,(0,r.getCartItem)(t.id);case 2:s=e.sent,n=s.data,i=[n,o],D.bookmarkPro.push(i),window.localStorage.setItem("state",JSON.stringify(D));case 7:case"end":return e.stop()}},e)}));return function(t,r){return e.apply(this,arguments)}}(),$=function(e){var t=e.target.closest(".button--cart");if(t){var r=t.previousElementSibling.children[1].value;V(t,1*r),t.closest(".product").setAttribute("data-page",!0);var o=t.closest(".product--description--container"),s=o.children[1].textContent;D.bookmarkItems.push(s),t.parentElement.classList.add("hide--again"),X(o,r,s),D.cartCount++,D.proCount++,G(D),window.localStorage.setItem("state",JSON.stringify(D))}};x&&x.addEventListener("click",$);var K=function(e){D.bookmarkPro=D.bookmarkPro.filter(function(t){return t[0].productName!==e.children[1].children[1].textContent}),D.proCount--},Q=function(e){if(e.target.classList.contains("button--remove--cart")){var t=e.target.closest(".product");t.setAttribute("data-page",!1),D.bookmarkItems=D.bookmarkItems.filter(function(e){return e!==t.children[1].children[1].textContent}),K(t),D.cartCount--,G(D),window.localStorage.setItem("state",JSON.stringify(D)),t.children[1].children[4].classList.remove("hide--again");var r=t.children[1],o=r.children[5];r.removeChild(o)}};x&&x.addEventListener("click",Q);var Y=JSON.parse(window.localStorage.getItem("state"));Y&&(Y.cartCount=Y.proCount=Y.bookmarkItems.length,D.cartCount=Y.bookmarkItems.length,G(D=Y));var Z=function(e){var t=j(document.querySelectorAll(".product"));t.map(function(e){return e.children[1].children[1].textContent});t.forEach(function(t){e.bookmarkItems.some(function(e){return e===t.children[1].children[1].textContent});var r=t.children[1].children[1].textContent;if(e.bookmarkItems.some(function(e){return e===r})){var o=a(e.bookmarkPro.filter(function(e){return e[0].productName==r}),1)[0];t.children[1].children[4].classList.add("hide--again"),X(t.children[1],o[1],r)}})};Z(D);var ee=function(){var e=w&&parseInt(window.getComputedStyle(C).height),t=w&&parseInt(window.getComputedStyle(w).height),r=1*(null==N?void 0:N.getBoundingClientRect().width);r&&r>390&&(w.style.maxHeight="".concat(t-e,"px"))};ee();var te,re,oe=0,se=function(){b.forEach(function(e,t){var r='<button class="dot" data-slide="'.concat(t,'"></button>');y.insertAdjacentHTML("beforeend",r)})},ne=function(e){b.forEach(function(t,r){var o=100*(r-e);t.style.transform="translateX(".concat(o,"%)")});var t;t=e,re.forEach(function(e,r,o){o[t].classList.add("dot--active"),e.dataset.slide!==t&&e!==o[t]&&e.classList.remove("dot--active")})};function ie(){return te=setInterval(function(){oe===b.length-1?oe=0:oe++,ne(oe)},1e4)}se(),re=document.querySelectorAll(".dot"),ne(0),ie();var ce=function(){te&&clearInterval(te),oe===b.length-1?oe=0:oe++,ne(oe),ie()},ae=function(){te&&clearInterval(te),0==oe?oe=b.length-1:oe--,ne(oe),ie()},ue=function(e){if(te&&clearInterval(te),e.target.classList.contains("dot")){var t=e.target.dataset.slide;t*=1;var r=e.target.closest(".dots--container").querySelectorAll(".dot");oe=t<b.length?t:oe,ne(t),e.target.classList.add("dot--active"),r.forEach(function(t){t!==e.target&&t.classList.remove("dot--active")})}};k&&k.addEventListener("click",ae),S&&S.addEventListener("click",ce),y&&y.addEventListener("click",ue),L.addEventListener("click",function(e){if(e.target.classList.contains("nav--link")){var t=e.target.getAttribute("href"),r=document.querySelector(t);null==r||r.scrollIntoView({behavior:"smooth"})}}),document.addEventListener("click",function(e){if(e.target.closest(".header--logo__container")&&window.localStorage.setItem("isClicked",JSON.stringify("Products")),e.target.closest(".image--link")){var t=C.getBoundingClientRect();window.scrollTo({left:t.left+window.pageXOffset,top:t.top+window.pageXOffset,behavior:"smooth"})}}),C.classList.remove("fixed");var le=C.getBoundingClientRect().height,de=C.getBoundingClientRect().width,me=window.getComputedStyle(C).width,fe=function(e,t){a(e,1)[0].isIntersecting?C.classList.remove("fixed"):C.classList.add("fixed")},je={root:null,threshold:0,rootMargin:"-".concat(le,"px")},ge=new IntersectionObserver(fe,je);N&&ge.observe(N);var ve=function(e,t){a(e,1)[0].isIntersecting?C.classList.add("fixed"):C.classList.remove("fixed")},pe={root:null,threshold:0,rootMargin:"".concat(20*le,"px")},he=new IntersectionObserver(ve,pe);x&&he.observe(x);var qe=function(e){var t=e.target.closest(".tertiary--header");t&&(j(t.parentElement.children).filter(function(e){return e!==t}).forEach(function(e){e.firstChild.classList.remove("active")}),t.firstChild.classList.add("active"),window.localStorage.setItem("isClicked",JSON.stringify(t.firstChild.textContent)))},ye=JSON.parse(window.localStorage.getItem("isClicked")),be=j(document.querySelectorAll(".link--category"));if(ye&&0!==window.location.search.length||ye&&window.location.pathname.startsWith("/productname"))var ke=be.filter(function(e){return e.textContent===ye?e.classList.add("active"):e.classList.remove("active"),e.textContent===ye});P&&P.addEventListener("click",qe),x&&x.addEventListener("click",function(e){var t=e.target.closest(".category");t&&window.localStorage.setItem("isClicked",JSON.stringify(t.firstChild.textContent))});var Se=document.querySelector(".inner--container__product");Se&&Se.addEventListener("click",function(e){var t=e.target.closest(".category");t&&window.localStorage.setItem("isClicked",JSON.stringify(t.firstChild.textContent))}),x&&x.addEventListener("click",function(e){var t=e.target.closest(".product-name");if(t){var r=t.parentElement.firstElementChild.firstChild.textContent;window.localStorage.setItem("isClicked",JSON.stringify(r))}}),document.addEventListener("click",function(e){var t;if((null===(t=e.target.closest(".cart--section"))||void 0===t?void 0:t.children[0].children[0])&&e.target.closest(".tertiary--header")){var r=e.target.firstChild.textContent;window.localStorage.setItem("isClicked",JSON.stringify(r))}});var Ce=document.querySelector(".full--product--description"),we=function(e){var t=e.target.closest(".button--cart");if(t){var r=t.closest(".inner--container__product"),o=r.children[3].textContent,s=t.parentElement,n=s.children[0].children[1].value;D.bookmarkItems.push(o),V(t,n),s.classList.add("hide--again"),X(r,n,o),D.cartCount++,G(D),window.localStorage.setItem("state",JSON.stringify(D))}};Ce&&Ce.addEventListener("click",we);var xe=function(e){if(window.location.pathname.includes("product")){var t=document.querySelector(".product-name"),r=t.parentElement,o=r.children[r.children.length-1];if(e.bookmarkItems.some(function(e){return e===t.textContent})){var s=a(e.bookmarkPro.filter(function(e){return e[0].productName==t.textContent}),1)[0];o.classList.add("hide--again"),X(r,s[1],t.textContent)}}};xe(Y);var Le=function(e){if(e.target.classList.contains("button--remove--cart")){var t=e.target.closest(".inner--container__product"),r=t.children[3].textContent;D.bookmarkItems=D.bookmarkItems.filter(function(e){return e!==r}),D.bookmarkPro=D.bookmarkPro.filter(function(e){return e[0].productName!==r}),D.cartCount--,G(D),window.localStorage.setItem("state",JSON.stringify(D)),t.children[t.children.length-2].classList.remove("hide--again");var o=t.children[t.children.length-1];t.removeChild(o)}};Ce&&Ce.addEventListener("click",Le);var Ee=function(e){var t,r=e.target.closest(".button-plus-minus");r&&(r.firstElementChild.classList.contains("feather-plus")?(t=1*r.previousElementSibling.value,t++,r.previousElementSibling.value=t):r.firstElementChild.classList.contains("feather-minus")&&(1!==(t=1*r.nextElementSibling.value)&&t--,r.nextElementSibling.value=t))};Se&&Se.addEventListener("click",Ee);var Ie,Ne=document.querySelector("#cart--display"),Ae=document.querySelector("main"),Oe=document.querySelector(".header--container"),_e=I.children[1],Pe=j(document.querySelectorAll("section")),Re=document.querySelector(".close--cart"),Je=document.querySelector(".close--cart--container");console.log(Pe.some(function(e){return e.classList.contains("cart--section")}));var Te,Fe,Me=function(e){if(!e){Ne.insertAdjacentHTML("beforeend",'<div class="close--cart--container"><p class="paragraph cart--is--empty">your cart is empty, kindly add an item to view cart <p> <p class="close--cart button">close<p><div>');var t=document.querySelector(".close--cart--container");Ie=setTimeout(function(){Ne.removeChild(t)},5e3)}},Ue=function(e){var t=j(document.querySelectorAll("".concat(e))).map(function(e){return e.textContent}).reduce(function(e,t){return e+Number(t)},0).toFixed(0);return[t,j(document.querySelectorAll("[data-total]")).map(function(e){return e.textContent}).reduce(function(e,t){return e+Number(t)},0)+Number(t)]},ze=function(e){if(e.target.closest(".button--cart")){var t=document.querySelector(".close--cart--container");if(0===D.bookmarkPro.length)return Me(t);if(!document.querySelector(".cart--lists")){Pe.forEach(function(e){Ae.removeChild(e)}),(0,o.default)(D,Ae);var r=Ue(".sub--totals");document.querySelector(".grand--total").textContent=r[0],console.log(document.querySelector(".final--total")),document.querySelector(".final--total").textContent=r[1];var s=document.querySelector(".cart--lists");s.children.length>=5&&s.classList.add("scroll")}}};Oe.addEventListener("click",ze),Ne.addEventListener("click",function(e){var t=e.target.closest(".close--cart--container");if(t){console.log(Ie),Ie&&clearTimeout(Ie);var r=t.closest(".close--cart--container");Ne.removeChild(r)}});var Be=function(e){var t=e.target.closest(".cart--list__element");if(t&&!t.classList.contains("cart--list__header")){var r=e.target.closest(".button-plus-minus"),o=t.children[3],s=t.children[2].children[0].firstElementChild,n=Number(s.textContent),i=t.children[4].children[0].firstElementChild,c=(Number(i.textContent),Number(o.children[1].value));if(null!=r&&r.classList.contains("button--plus")){Fe=++c,o.children[1].value=c,Te=c*n,i.textContent=Te.toFixed(2);var a=Ue(".sub--totals");document.querySelector(".grand--total").textContent=a[0],document.querySelector(".final--total").textContent=a[1]}if(null!=r&&r.classList.contains("button--minus")&&o.children[1].value-1!=0){Fe=--c,o.children[1].value=c,Te=c*n,i.textContent=Te.toFixed(2);var u=Ue(".sub--totals");document.querySelector(".grand--total").textContent=u[0],document.querySelector(".final--total").textContent=u[1]}}};document.addEventListener("click",Be),document.addEventListener("change",function(e){var t=e.target.closest(".product--unit--quantity");if(t){var r=Number(t.value),o=t.closest(".cart--list__element"),s=Number(o.children[2].children[0].firstElementChild.textContent);o.children[4].children[0].firstElementChild.textContent=r*s;var n=Ue(".sub--totals");document.querySelector(".grand--total").textContent=n[0],document.querySelector(".final--total").textContent=n[1]}});var He=function(e){var t=e.target.closest(".button--close");if(t){var r=t.closest(".cart--list__element"),o=t.closest(".cart--lists"),s=r.children[1].children[0].textContent;D.bookmarkItems=D.bookmarkItems.filter(function(e){return e!==s}),D.bookmarkPro=D.bookmarkPro.filter(function(e){return e[0].productName!==s}),D.cartCount--,D.proCount--,G(D),o.removeChild(r);var n=Ue(".sub--totals");document.querySelector(".grand--total").textContent=n[0],document.querySelector(".final--total").textContent=n[1],o.children.length<=5&&o.classList.remove("scroll"),window.localStorage.setItem("state",JSON.stringify(D)),1==o.children.length&&location.reload()}};document.addEventListener("click",He);var We=document.querySelector(".form"),Xe=function(){var e=f(regeneratorRuntime.mark(function e(t){var r,o,n;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(t.preventDefault(),!(r=j(document.querySelectorAll(".form--input"))).some(function(e){return""==e.value})){e.next=4;break}return e.abrupt("return",console.log("pls fil in the space"));case 4:if(o=r.map(function(e){return[e.getAttribute("name"),e.value]}),n=o&&Object.fromEntries(o),!We.lastElementChild.classList.contains("signup--check")){e.next=10;break}return console.log("yes it does signup"),e.next=10,(0,s.signUp)(n.firstname,n.lastname,n.email,n.password,n.passwordConfirmed);case 10:if(console.log("done"),!We.lastElementChild.classList.contains("login--check")){e.next=15;break}return console.log("yes it does login"),e.next=15,(0,s.login)(n.email,n.password);case 15:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}();We&&We.addEventListener("submit",Xe);var De=document.querySelector(".all--buttons"),Ge=function(){var e=f(regeneratorRuntime.mark(function e(t){var r;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(!(r=t.target.closest(".list--cta"))||"link--outline"!=r.firstElementChild.id){e.next=4;break}return e.next=4,(0,s.logout)();case 4:case"end":return e.stop()}},e)}));return function(t){return e.apply(this,arguments)}}();De&&De.addEventListener("click",Ge);var Ve=document.querySelector(".checkout--button"),$e=function(){var e=f(regeneratorRuntime.mark(function e(t){var r;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(e.prev=0,!t.target.closest(".full--product--description")){e.next=6;break}return r=Ve.dataset.id,e.next=6,(0,n.buyFood)(r);case 6:e.next=11;break;case 8:e.prev=8,e.t0=e.catch(0),console.log(e.t0);case 11:case"end":return e.stop()}},e,null,[[0,8]])}));return function(t){return e.apply(this,arguments)}}(),Ke=function(){var e=f(regeneratorRuntime.mark(function e(t){var r,o,s;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(e.prev=0,!(r=t.target.closest(".checkout--button"))||!r.closest(".checkout--side")){e.next=8;break}return o=D.bookmarkPro,s=o.map(function(e){return e[0].id}).join(","),console.log(s),e.next=8,(0,n.buyFood)(s);case 8:e.next=13;break;case 10:e.prev=10,e.t0=e.catch(0),console.log(e.t0);case 13:case"end":return e.stop()}},e,null,[[0,10]])}));return function(t){return e.apply(this,arguments)}}();Ve&&Ve.addEventListener("click",$e),document.addEventListener("click",Ke);var Qe="Emeka,oga",Ye=Qe.split(",");console.log(Ye);var Ze=new Promise(function(e,t){setTimeout(function(){return e("resolved")},2e3)}),et=new Promise(function(e,t){setTimeout(function(){return t("resolved 2")},1e3)}),tt=[Ze,et],rt=function(){var e=f(regeneratorRuntime.mark(function e(){var t;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=0,e.next=3,Promise.any(tt);case 3:t=e.sent,console.log(t),e.next=10;break;case 7:e.prev=7,e.t0=e.catch(0),console.log("err ".concat(e.t0));case 10:case"end":return e.stop()}},e,null,[[0,7]])}));return function(){return e.apply(this,arguments)}}();rt();
},{"core-js/modules/es6.array.copy-within.js":"c9DC","core-js/modules/es6.array.fill.js":"ZBH0","core-js/modules/es6.array.filter.js":"PXKF","core-js/modules/es6.array.find.js":"wTIB","core-js/modules/es6.array.find-index.js":"ksrS","core-js/modules/es7.array.flat-map.js":"zKV8","core-js/modules/es6.array.from.js":"WZRw","core-js/modules/es7.array.includes.js":"gMo0","core-js/modules/es6.array.iterator.js":"ZCkT","core-js/modules/es6.array.map.js":"O0lf","core-js/modules/es6.array.of.js":"URTo","core-js/modules/es6.array.slice.js":"Ui7t","core-js/modules/es6.array.sort.js":"TqUy","core-js/modules/es6.array.species.js":"Adki","core-js/modules/es6.date.to-primitive.js":"nktC","core-js/modules/es6.function.has-instance.js":"owRX","core-js/modules/es6.function.name.js":"z3jV","core-js/modules/es6.map.js":"ksBa","core-js/modules/es6.math.acosh.js":"o78V","core-js/modules/es6.math.asinh.js":"xkGF","core-js/modules/es6.math.atanh.js":"Pmrp","core-js/modules/es6.math.cbrt.js":"Giui","core-js/modules/es6.math.clz32.js":"HsTu","core-js/modules/es6.math.cosh.js":"xEUq","core-js/modules/es6.math.expm1.js":"aBEU","core-js/modules/es6.math.fround.js":"IjCR","core-js/modules/es6.math.hypot.js":"HXfT","core-js/modules/es6.math.imul.js":"m2OX","core-js/modules/es6.math.log1p.js":"ymfv","core-js/modules/es6.math.log10.js":"E567","core-js/modules/es6.math.log2.js":"hUIM","core-js/modules/es6.math.sign.js":"d1Y4","core-js/modules/es6.math.sinh.js":"dhHM","core-js/modules/es6.math.tanh.js":"cxv8","core-js/modules/es6.math.trunc.js":"xO7u","core-js/modules/es6.number.constructor.js":"F74v","core-js/modules/es6.number.epsilon.js":"oSwj","core-js/modules/es6.number.is-finite.js":"Iwqp","core-js/modules/es6.number.is-integer.js":"XPnJ","core-js/modules/es6.number.is-nan.js":"PMgb","core-js/modules/es6.number.is-safe-integer.js":"EvBV","core-js/modules/es6.number.max-safe-integer.js":"fOC8","core-js/modules/es6.number.min-safe-integer.js":"yvVo","core-js/modules/es6.number.parse-float.js":"a09l","core-js/modules/es6.number.parse-int.js":"fCj1","core-js/modules/es6.object.assign.js":"av62","core-js/modules/es7.object.define-getter.js":"y7i0","core-js/modules/es7.object.define-setter.js":"vFGQ","core-js/modules/es7.object.entries.js":"jLAB","core-js/modules/es6.object.freeze.js":"bkZb","core-js/modules/es6.object.get-own-property-descriptor.js":"xCvV","core-js/modules/es7.object.get-own-property-descriptors.js":"ovdg","core-js/modules/es6.object.get-own-property-names.js":"mVnl","core-js/modules/es6.object.get-prototype-of.js":"Dkc5","core-js/modules/es7.object.lookup-getter.js":"urEd","core-js/modules/es7.object.lookup-setter.js":"qicQ","core-js/modules/es6.object.prevent-extensions.js":"OeTo","core-js/modules/es6.object.to-string.js":"zmtK","core-js/modules/es6.object.is.js":"OI80","core-js/modules/es6.object.is-frozen.js":"Lm2M","core-js/modules/es6.object.is-sealed.js":"Lrni","core-js/modules/es6.object.is-extensible.js":"ypI7","core-js/modules/es6.object.keys.js":"RpZ9","core-js/modules/es6.object.seal.js":"LEG2","core-js/modules/es6.object.set-prototype-of.js":"xZ9m","core-js/modules/es7.object.values.js":"exYH","core-js/modules/es6.promise.js":"MWl4","core-js/modules/es7.promise.finally.js":"q6pY","core-js/modules/es6.reflect.apply.js":"sL26","core-js/modules/es6.reflect.construct.js":"n0sj","core-js/modules/es6.reflect.define-property.js":"XoPA","core-js/modules/es6.reflect.delete-property.js":"YgqD","core-js/modules/es6.reflect.get.js":"Jr0s","core-js/modules/es6.reflect.get-own-property-descriptor.js":"rsHl","core-js/modules/es6.reflect.get-prototype-of.js":"mTTK","core-js/modules/es6.reflect.has.js":"VxVc","core-js/modules/es6.reflect.is-extensible.js":"lQ3X","core-js/modules/es6.reflect.own-keys.js":"vOF6","core-js/modules/es6.reflect.prevent-extensions.js":"hWQ0","core-js/modules/es6.reflect.set.js":"AiN1","core-js/modules/es6.reflect.set-prototype-of.js":"EPEE","core-js/modules/es6.regexp.constructor.js":"lK2M","core-js/modules/es6.regexp.flags.js":"S072","core-js/modules/es6.regexp.match.js":"Iomp","core-js/modules/es6.regexp.replace.js":"weWA","core-js/modules/es6.regexp.split.js":"d289","core-js/modules/es6.regexp.search.js":"EA9T","core-js/modules/es6.regexp.to-string.js":"jkaB","core-js/modules/es6.set.js":"jPMF","core-js/modules/es6.symbol.js":"rGq9","core-js/modules/es7.symbol.async-iterator.js":"enid","core-js/modules/es6.string.anchor.js":"eRhq","core-js/modules/es6.string.big.js":"HLSM","core-js/modules/es6.string.blink.js":"RtH9","core-js/modules/es6.string.bold.js":"efe7","core-js/modules/es6.string.code-point-at.js":"gGid","core-js/modules/es6.string.ends-with.js":"PmIB","core-js/modules/es6.string.fixed.js":"v3Ez","core-js/modules/es6.string.fontcolor.js":"RECM","core-js/modules/es6.string.fontsize.js":"l7OI","core-js/modules/es6.string.from-code-point.js":"DdG0","core-js/modules/es6.string.includes.js":"qgIv","core-js/modules/es6.string.italics.js":"uJlj","core-js/modules/es6.string.iterator.js":"WN4F","core-js/modules/es6.string.link.js":"vYww","core-js/modules/es7.string.pad-start.js":"hmYY","core-js/modules/es7.string.pad-end.js":"RIKd","core-js/modules/es6.string.raw.js":"KDcE","core-js/modules/es6.string.repeat.js":"ZAbm","core-js/modules/es6.string.small.js":"AiXZ","core-js/modules/es6.string.starts-with.js":"U3MC","core-js/modules/es6.string.strike.js":"MhVl","core-js/modules/es6.string.sub.js":"DFMN","core-js/modules/es6.string.sup.js":"X3LC","core-js/modules/es7.string.trim-left.js":"hNft","core-js/modules/es7.string.trim-right.js":"uLyC","core-js/modules/es6.typed.array-buffer.js":"VqD6","core-js/modules/es6.typed.int8-array.js":"FrGE","core-js/modules/es6.typed.uint8-array.js":"jLcZ","core-js/modules/es6.typed.uint8-clamped-array.js":"dFjM","core-js/modules/es6.typed.int16-array.js":"XAXm","core-js/modules/es6.typed.uint16-array.js":"Vod2","core-js/modules/es6.typed.int32-array.js":"Mnlj","core-js/modules/es6.typed.uint32-array.js":"JJCv","core-js/modules/es6.typed.float32-array.js":"Asas","core-js/modules/es6.typed.float64-array.js":"ZKGF","core-js/modules/es6.weak-map.js":"Y0Wb","core-js/modules/es6.weak-set.js":"oeIc","core-js/modules/web.timers.js":"pUQh","core-js/modules/web.immediate.js":"uORE","core-js/modules/web.dom.iterable.js":"kCWy","regenerator-runtime":"VuXv","regenerator-runtime/runtime.js":"VuXv","./search":"zfSF","./carts":"fDTP","./loadFullCart":"Eq09","./logins":"C0nW","./stripe":"Uj2q","./alert":"acK6"}]},{},["Focm"], null)
>>>>>>> working
