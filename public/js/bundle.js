...
parentCartContainer && addEventListener('click', addtoCart); // REMOVE FROM CART
...
if (localState) {
  // allState = localState;
  allState.cartCount = localState.cartCount; // should havebeen allState.cartcount = localState.bookmarkItems.length
