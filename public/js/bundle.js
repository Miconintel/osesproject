      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            if (clicked.firstElementChild.classList.contains('link--outline')) console.log('rihght');
            _context3.next = 4;
