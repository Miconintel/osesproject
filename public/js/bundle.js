      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/checkout-session/".concat(foodId));
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"view/view.js":[function(require,module,exports) {
"use strict";
...
var View = /*#__PURE__*/function () {
  function View(parentContainer) {
    ...
    _classPrivateFieldSet(this, _parentContainer, parentContainer);
  }

  _createClass(View, [{
    key: "clickHandler",
    value: function clickHandler(handlerFunction) {
      _classPrivateFieldGet(this, _parentContainer).addEventListener('click', handlerFunction);
    }
  }]);
...
var _default = View;
exports.default = _default;
},{}],"helper/handler.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.searchHandlerFunction = void 0;

var searchHandlerFunction = function searchHandlerFunction(e) {
  console.log('clicked class');
};

exports.searchHandlerFunction = searchHandlerFunction;
...
var _handler = require("./helper/handler");
...
var view = new _view.default(buttonSearch);
view.clickHandler(_handler.searchHandlerFunction);
console.log(view); // SEARCH BAR
...
var hiu = [2, 4, 5, 7]; // console.log(hiu.filter((e) => 2 === e).join());
...
var addToCartPro = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(clickedProduct, noOfItems) {
    var bookmarkPro, data, allData, newData;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 2:
            ...
            newData = [].concat(_toConsumableArray(allState.bookmarkPro), [allData]);
            allState.bookmarkPro = newData; // allState.bookmarkPro.push(allData);
...
var reloadButtons = function reloadButtons(state) {
  ...
  allProducts.forEach(function (el) {
    ...
    if (state.bookmarkItems.some(function (eli) {
      ...
      var _parent = el.children[1].children[4];

      _parent.classList.add('hide--again');
...
var closeContainer = document.querySelector('.close--cart--container'); // console.log(sections.some((el) => el.classList.contains('cart--section')));
// handlerfunction
...
var showCarts = function showCarts(e) {
  ...
  if (clicked) {
    ...
    var secAvail = document.querySelector('.cart--lists'); // confirm to make sure u have not opened it before so it doesnt open twice,
    ...
    if (!secAvail) {
      ...
      document.querySelector('.grand--total').textContent = totals[0]; // console.log(document.querySelector('.final--total'));
...
var setNew = function setNew(clicked, currentValue) {
  var bookProList = _toConsumableArray(allState.bookmarkPro); // get the product whose value has changed


  var itemIndex = bookProList.findIndex(function (el) {
    return el[0].id === clicked.id;
  }); // get the main item

  var mainItem = bookProList[itemIndex];
...
var addQtyPrice = function addQtyPrice(e) {
  ...
  if (checkButton !== null && checkButton !== void 0 && checkButton.classList.contains('button--plus')) {
    ...
    qtyIcons.children[1].value = currentValue; // update quantity here

    setNew(clicked, currentValue); // const bookProList = [...allState.bookmarkPro];
...
document.addEventListener('click', removeFromCartPAge); // ON CHANGE
...
var buyFoodHandler = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
    var _parent2, theValueAmount, id, item, str;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _parent2 = e.target.closest('.full--product--description');

            if (!(_parent2 && e.target.closest('.checkout--button'))) {
              _context4.next = 11;
              break;
            }

            theValueAmount = e.target.closest('.checkout--button').previousElementSibling.lastElementChild.children[0].children[1].value * 1;
            console.log(theValueAmount);
            id = checkoutButton.dataset.id;
            item = [{
              id: id,
...
var buyFoodHandlerMany = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(e) {
    var _parent3, all, id, str;
    ...
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _parent3 = e.target.closest('.checkout--button');

            if (!(_parent3 && _parent3.closest('.checkout--side') && e.target.closest('.checkout--button'))) {
              _context5.next = 10;
              break;
            }

            all = _toConsumableArray(allState.bookmarkPro);
            console.log(all);
            id = all.map(function (el) {
              var item = {
                id: el[0].id,
                amount: el[1]
              };
  ...
  return function buyFoodHandlerMany(_x6) {
...
var grandParent = /*#__PURE__*/function () {
  function grandParent(prop) {
    _classCallCheck(this, grandParent);

    _classPrivateFieldInitSpec(this, _prop, {
      writable: true,
      value: void 0
    });
  ...
  _createClass(grandParent, [{
    key: "calculateProp",
    value: function calculateProp(el) {
      return _classPrivateFieldGet(this, _prop) * el;
    }
  }]);
...
var _parentProp = /*#__PURE__*/new WeakMap();

var parent = /*#__PURE__*/function (_grandParent) {
  _inherits(parent, _grandParent);

  var _super = _createSuper(parent);

  function parent(prop, age) {
    var _this;
    ...
    _classPrivateFieldInitSpec(_assertThisInitialized(_this), _parentProp, {
      writable: true,
      value: 3
    });
...
var rita = new parent(8, 50); // let number = 6;
// switch (number) {
//   case 1:
...
nums();
var arr = [6, 6, 6, 2, 2, 8];
var yu = arr.reduce(function (acc, el) {
