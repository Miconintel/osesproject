...
console.log(ButtonSearch); // SEARCH BAR
...
ButtonSearch.addEventListener('click', function (e) {
  ...
  ButtonSearch.setAttribute('href', "/?productName=".concat(productCategory, "&page=1"));
  window.localStorage.setItem('isClicked', JSON.stringify(productCategory)); // searchFood(searchInput)
}); //
//
//
// MOBILE NAV
